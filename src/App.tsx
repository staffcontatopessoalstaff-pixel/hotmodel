    ...
    const checkStatus = async () => {
      try {
        const response = await fetch(
          `/api/verificar-pagamento?id=${paymentId}`,
        );
  ...
  const handleLeadSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.ok) {
        ...
        setPaymentError(
          data.erro || "Erro ao gerar o Pix via Dice API. Tente novamente.",
        );
      }
    } catch (err: any) {
      setPaymentLoading(false);
          ...
          <>
            <section className="hero-section">
              ...
              <p className="hero-subtitle">
                O mesmo template validado usado pelos maiores players. Design
                perfeito, totalmente responsivo e pronto para você configurar
                com qualquer modelo e vender assinaturas simuladas que convertem
                10x mais.
              </p>
            ...
            >
              ...
              >
                Veja o Template em Ação
              </h2>
              <p style={{ color: "#94a3b8", marginBottom: "30px" }}>
                Navegue pelo tema real diretamente abaixo (preview interativo):
              </p>
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ color: "#94a3b8", fontSize: "0.95rem" }}>
                      Acesso total aos arquivos do template para você hospedar
                      onde quiser (Vercel, Hostinger, etc).
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ color: "#94a3b8", fontSize: "0.95rem" }}>
                      Layout desenvolvido para ter a maior semelhança possível,
                      gerando 100% de confiança no clique.
                    </p>
                  </div>
                </div>
                <div
                ...
                >
                  ...
                  <div>
                    <h3 style={{ fontSize: "1.1rem", marginBottom: "5px" }}>
                      Integração Pronta para Checkout
                    </h3>
                    <p style={{ color: "#94a3b8", fontSize: "0.95rem" }}>
                      Botões de assinatura já configurados e otimizados para
                      receber o seu link de pagamento direto.
                    </p>
                  </div>
                </div>
              </div>
              ...
              >
                ...
                >
                  <span style={{ color: "#cbd5e1" }}>
                    Template Privacy Fake Completo
                  </span>
                  <span style={{ fontWeight: "bold" }}>
                    R$ {TEMPLATE_PRICE.toFixed(2)}
                  </span>
                </div>
                <div
                  style={{
        ...
        {checkoutStep === 2 && (
          <div className="checkout-modal">
            <div className="checkout-content" style={{ textAlign: "center" }}>
              ...
              >
                Copie o código abaixo e pague no aplicativo do seu banco. O
                acesso ao código fonte será liberado automaticamente.
              </p>
          ...
          <div className="checkout-modal">
            ...
            >
              ...
              >
                ...
                >
                  <li>
                    O link para download do código fonte completo foi enviado
                    para o seu e-mail: <strong>{custEmail}</strong>
                  </li>
                  <li>
                    Você também receberá uma mensagem no WhatsApp com as
                    instruções de instalação rápida.
                  </li>
                  <li>
                    Caso não receba em até 5 minutos, verifique a caixa de spam
